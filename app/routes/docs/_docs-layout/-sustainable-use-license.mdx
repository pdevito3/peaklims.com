...
Peak LIMS's [Sustainable Use License](https://github.com/peaklims/PeakLimsApi/blob/main/LICENSE.md) and [Peak LIMS Enterprise License](https://github.com/peaklims/PeakLimsApi/blob/main/LICENSE_EE.md) are based on the [fair-code](http://faircode.io/) model.

## License FAQs

### What license do you use?

Peak LIMS uses the [Sustainable Use License](https://github.com/peaklims/PeakLimsApi/blob/main/LICENSE.md) and
[Peak LIMS Enterprise License](https://github.com/peaklims/PeakLimsApi/blob/main/LICENSE_EE.md). These licenses
...
The [Sustainable Use License](https://github.com/peaklims/PeakLimsApi/blob/main/LICENSE.md) applies to all our public source code hosted in our 
...
if you're still unclear, email us at [support@peaklims.com](mailto:support@peaklims.com).
...
and if you're still unclear, email us at [support@peaklims.com](mailto:support@peaklims.com).
...
Peak LIMS asks every contributor to sign our [Contributor License Agreement](https://github.com/peaklims/PeakLimsApi/blob/main/CONTRIBUTOR_LICENSE_AGREEMENT.md). 
